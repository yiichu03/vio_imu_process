...
/**
 * @file SimpleFrameRelativePoseSacProblem.hpp
 * @brief Header file for the SimpleFrameRelativePoseSacProblem class.
 * @author
 */

#ifndef INCLUDE_SWIFT_VIO_SIMPLESimpleFrameRelativePoseSacProblem_H_
#define INCLUDE_SWIFT_VIO_SIMPLESimpleFrameRelativePoseSacProblem_H_
 ...
 */
class SimpleFrameRelativePoseSacProblem : public CentralRelativePoseSacProblem {
 public:
  ...
  /**
   * \brief SimpleFrameRelativePoseSacProblem
   ...
   */
  SimpleFrameRelativePoseSacProblem(adapter_t & adapter, algorithm_t algorithm)
  ...
  virtual ~SimpleFrameRelativePoseSacProblem() {
  }
...
#endif /* INCLUDE_SWIFT_VIO_SIMPLESimpleFrameRelativePoseSacProblem_H_ */
