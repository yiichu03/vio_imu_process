...
/**
 * @file Feature2d2dMatchingAlgorithm.cpp
 * @brief Source file for the Feature2d2dMatchingAlgorithm class.
 * @author Jianzhu Huai
 */
...
namespace swift_vio {
Feature2d2dMatchingAlgorithm::Feature2d2dMatchingAlgorithm(
    ConstMultiFramePtr mfA, ConstMultiFramePtr mfB, size_t camIdA,
    size_t camIdB, const BinaryDescriptorDistanceCallback &callback,
    float distanceThreshold)
    : frameA_(mfA), frameB_(mfB), camIdA_(camIdA), camIdB_(camIdB),
...
void Feature2d2dMatchingAlgorithm::doSetup() {
...
size_t Feature2d2dMatchingAlgorithm::sizeA() const {
  return frameA_->numKeypoints(camIdA_);
}

size_t Feature2d2dMatchingAlgorithm::sizeB() const {
...
void Feature2d2dMatchingAlgorithm::setDistanceThreshold(
    float distanceThreshold) {
  distanceThreshold_ = distanceThreshold;
}

// Get the distance threshold for which matches exceeding it will not be returned as matches.
float Feature2d2dMatchingAlgorithm::distanceThreshold() const {
  return distanceThreshold_;
}

// Geometric verification of a match.
bool Feature2d2dMatchingAlgorithm::verifyMatch(
...
void Feature2d2dMatchingAlgorithm::reserveMatches(
    size_t numMatches) {
  matches_.reserve(numMatches);
}

size_t Feature2d2dMatchingAlgorithm::numMatches() {
  return numMatches_;
}

//size_t Feature2d2dMatchingAlgorithm::numUncertainMatches() {
...
void Feature2d2dMatchingAlgorithm::setBestMatch(
